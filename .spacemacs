...
`dotspacemacs/user-config' first."
  ...
  ; python flake8 checking
  (add-hook 'python-mode-hook (defsubst carl/blah () (setq-local flycheck-disabled-checkers nil)))
